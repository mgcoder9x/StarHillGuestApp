...
- Status: Accepted/Implemented (2026-07-16; H-Hk.1 persistence/schema/boundary + H-Hk.2 Application [create idempotent + rule-gate + máy trạng thái + event-log + complete app/token + cancel-for-visit + guest status]; api/host ở H-Hk.3)
- Date: 2026-07-16
...
- Guard-Tests: `HousekeepingBoundaryTests`, `HousekeepingPostgresConstraintTests`, `HousekeepingUseCaseTests`, `HousekeepingConcurrencyTests`
