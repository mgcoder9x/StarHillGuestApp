...
/// <summary>
/// Slot #3 pipeline (§3.5): bọc ngoài mọi lỗi phía sau. Map <see cref="ConcurrencyConflictException"/> (kernel,
/// KHÔNG phụ thuộc EF — F5) → 409; lỗi khác → 500 trung lập. LOG path QUA MASKER (CP13/F15) — token không lọt
/// vào log kể cả request lỗi 500 (chính lỗ hổng F15). Response lỗi dựng qua <see cref="ProblemDetailsWriter"/>.
/// </summary>
