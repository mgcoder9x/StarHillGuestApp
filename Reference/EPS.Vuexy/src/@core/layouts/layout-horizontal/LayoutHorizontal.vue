    ...
    >
        ...
        <transition :name="routerTransition" mode="out-in">
            <component
                ...
                :breadcrumbTypeClass="breadcrumbTypeClass"
                :key="
...
export default {
    ...
    setup() {
        ...
        const {
            ...
            overlayClasses,
            resizeHandler,
        } = useVerticalLayout(navbarType, footerType, breadcrumbType)
        ...
        const { navbarMenuTypeClass, layoutClasses, footerTypeClass, breadcrumbTypeClass } =
            useLayoutHorizontal(navbarType, footerType, breadcrumbType, isVerticalMenuActive)
