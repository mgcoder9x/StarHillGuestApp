<template>
    ...
    >
        ...
        >
            <Icon icon="uil:setting" class="spinner md-icon" style="color: #e2e8f0"/>
        </b-link>
        <!-- /Toggler -->
        ...
        >
            ...
            <span @click="isCustomizerOpen = !isCustomizerOpen">
                <Icon
                    icon="material-symbols:close"
                    class="cursor-pointer md-icon"
                />
            </span>
            <!-- <feather-icon
                icon="XIcon"
        ...
        >
            ...
            <div class="customizer-section">
                ...
                <b-form-group
                    :label="
                        layoutType === 'vertical' ? 'Navbar Type' : 'Menu Type'
                    "
                >
                    <b-form-radio-group
                        v-model="navbarType"
            ...
            <div class="customizer-section">
             ...
             <!-- SECTION: Breadcrumb -->
               <div class="customizer-section">
                    <b-form-group label="Breadcrumb Type">
                        <b-form-radio-group
                        v-model="breadcrumbType"
