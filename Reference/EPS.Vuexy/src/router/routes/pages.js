export default [
    ...
    },
    {
        ...
        component: () =>
            import('@/views/pages/account-setting/ChangePassword.vue'),
        meta: {
            pageTitle: 'ChangePassword.Header.Account',
            breadcrumb: [
                {
                    text: 'ChangePassword.Header.ChangePass',
                    active: true,
                },
            ],
        },
    ...
    {
        path: '/pages/AccountSettingNotification',
        name: 'pages-setting-notification',
        component: () =>
            import(
                '@/views/pages/account-setting/AccountSettingNotification.vue'
            ),
        meta: {
            pageTitle: 'AccountSetting.Title',
            breadcrumb: [
                // {
                //     text: 'Trang lẻ',
                // },
                {
                    text: 'AccountSetting.Title',
                    active: true,
                },
            ],
        },
