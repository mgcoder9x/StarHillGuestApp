    ...
    <div class="sidebar-left">
        <div class="sidebar">
            ...
            <user-profile-sidebar
                ...
                @close-sidebar="
                    $emit('update:shall-show-user-profile-sidebar', false)
                "
            />
            ...
            >
                ...
                <span class="sidebar-close-icon">
                    <feather-icon
                        ...
                        size="16"
                        @click="
                            $emit('update:mq-shall-show-left-sidebar', false)
                        "
                    />
                </span>
                ...
                <div class="chat-fixed-search">
                    <div class="d-flex align-items-center w-100">
                        ...
                        <!-- Search -->
                        <b-input-group
                            class="input-group-merge ml-1 w-100 round"
                        >
                ...
                >
                    ...
                    <ul class="chat-users-list chat-list media-list">
                        <chat-contact
                            ...
                            tag="li"
                            :class="{
                                active: activeChatContactId === contact.id,
                            }"
                            is-chat-contact
