<template>
    ...
    <div style="height: inherit">
            ...
            <div class="app-action">
                ...
                >
                    ...
                    >
                        ...
                        <b-dropdown-item
                            @click="moveSelectedEmailsToFolder('draft')"
                        >
                    ...
                    >
                        ...
                        <b-dropdown-item
                            @click="updateSelectedEmailsLabel('personal')"
                        >
                            <span
                        ...
                        <b-dropdown-item
                            @click="updateSelectedEmailsLabel('company')"
                        >
                            <span
                                class="mr-50 bullet bullet-primary bullet-sm"
                            />
                            <span>Company</span>
                        </b-dropdown-item>
                        <b-dropdown-item
                            @click="updateSelectedEmailsLabel('important')"
                        >
                            <span
                        ...
                        <b-dropdown-item
                            @click="updateSelectedEmailsLabel('private')"
                        >
                            <span
        ...
        <portal to="content-renderer-sidebar-left">
            <email-left-sidebar
                :shall-show-email-compose-modal.sync="
...
export default {
    ...
    setup() {
        ...
        const updateRouteQuery = (val) => {
            const currentRouteQuery = JSON.parse(
