        ...
        <div class="email-detail-header">
            ...
            <div class="email-header-right ml-2 pl-1">
                ...
                <feather-icon
                    ...
                    :class="{
                        'text-warning fill-current': emailViewData.isStarred,
                    }"
                ...
                >
                    ...
                    <b-dropdown-item
                        @click="$emit('move-email-to-folder', 'draft')"
                    >
                    ...
                    <b-dropdown-item
                        @click="$emit('move-email-to-folder', 'spam')"
                    >
                ...
                >
                    ...
                    <b-dropdown-item
                        @click="$emit('update-email-label', 'personal')"
                    >
                        <span class="mr-50 bullet bullet-success bullet-sm" />
                        <span>Personal</span>
                    </b-dropdown-item>
                    <b-dropdown-item
                        @click="$emit('update-email-label', 'company')"
                    >
                        <span class="mr-50 bullet bullet-primary bullet-sm" />
                        <span>Company</span>
                    </b-dropdown-item>
                    <b-dropdown-item
                        @click="$emit('update-email-label', 'important')"
                    >
                        <span class="mr-50 bullet bullet-warning bullet-sm" />
                        <span>Important</span>
                    </b-dropdown-item>
                    <b-dropdown-item
                        @click="$emit('update-email-label', 'private')"
                    >
        ...
        >
            ...
            >
                <b-col cols="12">
                    ...
                    >
                        View {{ emailViewData.replies.length }} Earlier
                        Message{{ emailViewData.replies.length > 1 ? 's' : '' }}
                    </b-link>
                </b-col>
            </b-row>
            ...
            <template v-if="showWholeThread">
                <b-row
                    v-for="threadMail in emailViewData.replies
                        .slice()
                        .reverse()"
                    :key="threadMail.id"
                >
