...
export const useEcommerce = () => {
    ...
    const addProductInWishlist = (productId) => {
        return store.dispatch('app-ecommerce/addProductInWishlist', {
            productId,
        })
    }
    ...
    const removeProductFromCart = (productId) => {
        return store.dispatch('app-ecommerce/removeProductFromCart', {
            productId,
        })
    }
...
export const useEcommerceUi = () => {
    ...
    const toggleProductInWishlist = (product) => {
        const { addProductInWishlist, removeProductFromWishlist } =
            useEcommerce()
