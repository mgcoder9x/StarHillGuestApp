<template>
    <b-card-code title="Custom Checkboxes">
        <b-card-text class="mb-0">
            ...
            <span>
                use Bootstrap's custom checkbox input to replace the browser
        ...
        <div class="demo-inline-spacing">
            ...
            <b-form-checkbox v-model="selected" value="C" disabled>
                Checked disabled
            </b-form-checkbox>
            <b-form-checkbox v-model="selected" value="D" disabled>
                Unchecked disabled
            </b-form-checkbox>
        </div>
