<template>
    <b-card-code title="Detecting new, invalid, and duplicate tags">
        <b-card-text>
            ...
            <code>tag-state</code>
            <span
                >will be emitted whenever new tags are entered into the new tag
                input element, tags that do not pass validation, or duplicate
                tags are detected. The event handler will receive three arrays
                as its arguments:
            </span>
