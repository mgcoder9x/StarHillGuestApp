<template>
    <b-card-code title="Select sizing (displayed rows)">
        <b-card-text>
            ...
            <span>
                prop to switch the custom select into a select list-box, rather
                than a dropdown. Set the
            </span>
            <code>select-size</code>
            <span>
                prop to a numerical value greater than 1 to control how many
                rows of options are visible.</span
            >
        </b-card-text>
