<template>
    <b-card-code title="Multiple select support">
        <b-card-text>
            ...
            <code>multiple</code>
            <span
                >, and control how many rows are displayed in the multiple
                select list-box by setting
            </span>
            <code>select-size</code>
            <span>
                to the number of rows to display. The default is to let the
                browser use its default (typically 4).
            </span>
        </b-card-text>
