<template>
    <b-card-code title="Locale">
        <b-card-text>
            ...
            <span>
                will format the displayed number in the users browser default
                locale. You can change the localized formatting by specifying a
                locale (or array of locales) via the
            </span>
            <code>locale</code>
            <span> prop. </span>
        </b-card-text>
