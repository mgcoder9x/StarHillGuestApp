                    ...
                    <b-form @submit.prevent="search">
                        ...
                        <b-row>
                            ...
                            <b-col :md="form.colMd">
                                ...
                                >
                                    <tree-select
                                        v-model="searchForm.filterAreaId"
                                        :dir="
                            ...
                            <b-col :md="form.colMd">
                                ...
                                >
                                    <tree-select
                                        v-model="searchForm.filterDeviceId"
                                        :dir="
                                            $store.state.appConfig.isRTL
                                                ? 'rtl'
                                                : 'ltr'
                    ...
                    <span v-else-if="column.field === 'action'">
                        <div class="center-icon text-nowrap">
                            <b-button
                                ...
                                :to="{
                                    path: `/event/faceEvent/detail/${row.eventId}`,
                                }"
                            >
                            ...
                            <b-button
                                ...
                                "
                                :to="{
                                    path: `/event/faceEvent/itinerary/1/${row.personId}/${searchForm.filterDateFrom}/${searchForm.filterDateTo}`,
                                }"
                            >
...
export default {
        ...
        return {
            ...
            table: {
                ...
                columns: [
                    ...
                    {
                        label: 'FaceEvent.Detail.Age',
                        field: 'age',
                        visible: false,
                    },
                    {
                        label: 'FaceEvent.Detail.Gender',
                        field: 'gender',
                        formatFn: (v) => {
                            if (v === 1) {
                    ...
                    { label: 'FaceEvent.Detail.DepName', field: 'depName' },
    ...
    watch: {
        ...
        'searchForm.filterDateFrom': function () {
            if (this.faceImagePreview && this.showAdvanced)
                this.searchForm.filterEventIdStr = ''
        },
        'searchForm.filterDateTo': function () {
            if (this.faceImagePreview && this.showAdvanced)
                this.searchForm.filterEventIdStr = ''
        },
        showAdvanced(val) {
            ...
            try {
                const res = await this.$services.post(
                    '/faceEvents/face-search',
                    {
                        ...
                        filterDateFrom: this.searchForm.filterDateFrom || null,
                        filterDateTo: this.searchForm.filterDateTo || null,
                    }
                )
        ...
        async exportData() {
            ...
            if (
                ...
                vm.searchDatas[1].options.forEach((devi) => {
                    if (
                        (vm.searchForm.filterDeviceId || []).includes(devi.id)
                    ) {
            ...
            vm.export_fields_vi = {
                ...
                [vm.$t('fireEvent.common.time')]: 'accessTime',
