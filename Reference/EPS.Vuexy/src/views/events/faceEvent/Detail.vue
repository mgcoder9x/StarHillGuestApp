            ...
            <b-form>
                <b-row>
                    ...
                    <b-col md="6">
                        ...
                        >
                            <b-form-input
                                v-model="event.recognitionObject"
                                readonly
                            />
                        </b-form-group>
                    </b-col>
                    ...
                    <b-col md="6">
                        <b-form-group
                            ...
                            label-cols-md="4"
                        >
                            <b-form-input v-model="event.genderName" readonly />
                        </b-form-group>
                    </b-col>
                    <b-col cols="12">
                        <b-form-group
        ...
        loadEventDetail() {
            this.$services
                ...
                .then((response) => {
                    ...
                    this.event.genderName = response.data.data.gender =
                        this.getGenderName(response.data.data.gender)
                })
        },
        //lookup data
        loadEventType() {
