        ...
        <b-card-body>
            <b-row>
                ...
                <b-col md="12" class="text-center">
                    <b-button
                        :to="{ path: '/event/workAtHeightMonitoring/list' }"
                        type="button"
...
export default {
    ...
    computed: {
        ...
        eventTypeName() {
            ...
            if (locale === 'vi') {
                return this.event.eventTypeName
            }
            return this.event.englishEventTypeName
        },
        safeText() {
            return this.event.isSafe
                ? this.$t(
        ...
        warningLevelName() {
            if(this.event.warningLevelId){
                return this.$t(`Events.ProtectiveEquipmentEvent.WarningLevels.${this.event.warningLevelId}`)
            }
            else{
                return this.$t(`Events.ProtectiveEquipmentEvent.WarningLevels.Unknown`)
            }
    ...
    methods: {
        ...
        async loadEventDetail() {
            ...
            const curEvent = response.data.data
            this.event = {
                ...curEvent,
                accessTime: moment
                    .utc(curEvent.accessTime)
