        ...
        <b-col cols="12">
            ...
            <b-card title="Default Colors" class="background-color">
                ...
                <b-card-text class="mb-0">
                    We have a series of colors that are used by default. They
                    include:
                </b-card-text>
                ...
                <b-card-text>
                    For each color, we think has its functionality in the
                    application as alerts of errors <b>(danger)</b>, warnings to
                    the user <b>(warning)</b>, communications of approval
                    <b>(success)</b>, or main color of the application
                    <b>(primary)</b>.
                </b-card-text>
                <!-- default -->
                ...
                <b-card-text class="mb-0">
                    Use
                    <code>.bg-{color}.bg-darken-{1 | 2 | 3 | 4}</code> classes
                    for darken background color.
                </b-card-text>
                <div class="d-flex justify-content-start flex-wrap">
                    <div
