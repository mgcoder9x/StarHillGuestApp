<template>
    <section id="lists">
        <div class="group-area mt-1">
            <h4>Lists</h4>
            <p>
                All lists - <code>&lt;ul&gt;</code>, <code>&lt;ol&gt;</code>,
                and <code>&lt;dl&gt;</code> - have their margin-top removed and
                a <code>margin-bottom: 1rem</code>. Nested lists have no
            ...
            <b-col md="4">
                <b-card title="Lists Unstyled">
                    <b-card-text>
                        ...
                        <code class="highlighter-rouge">list-style</code> and
            ...
            <b-col md="6">
                <b-card title="Lists icons">
                    ...
                    <ul class="list-style-icons">
                        <li>
                            <feather-icon icon="ArrowRightIcon" />Facilisis in
                            pretium nisl aliquet
                        </li>
                        <li>
                            <feather-icon icon="ArrowRightIcon" />Nulla volutpat
                            aliquam velit
                            <ul class="list-style-icons">
                                <li>
                                    <feather-icon
                                ...
                                <li>
                                    <feather-icon icon="ChevronRightIcon" />Ac
                                    tristique libero volutpat at
                                </li>
                            </ul>
                        </li>
                        <li>
                            <feather-icon icon="ArrowRightIcon" />Faucibus porta
                            lacus fringilla vel
                        </li>
                        <li>
                            <feather-icon icon="ArrowRightIcon" />Aenean sit
                            amet erat nunc
                        </li>
                    </ul>
                </b-card>
