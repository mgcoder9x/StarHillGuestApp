            ...
            <b-card no-body>
                ...
                <b-card-body class="pb-1">
                    <b-card-text>
                        ...
                        font-weight. Use <code>.font-weight-normal</code> for
                        light heading and <code>.font-weight-bolder</code> for
                        bold headings along with heading tags or classes.
                    </b-card-text>
                </b-card-body>
            ...
            <b-card no-body>
                ...
                <b-card-body class="pb-1">
                    <b-card-text
                        ...
                        secondary heading text.</b-card-text
                    >
                </b-card-body>
            ...
            <b-card no-body>
                ...
                <b-card-body class="pb-1">
                    <b-card-text>
                        ...
                        options. Use <code>.text-{colorName}</code> class with
                        heading elements.
                    </b-card-text>
                </b-card-body>
