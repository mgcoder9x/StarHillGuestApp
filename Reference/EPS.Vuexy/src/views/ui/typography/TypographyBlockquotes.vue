        ...
        <b-row class="match-height">
            ...
            <b-col cols="12">
                <div class="group-area mt-1">
                    ...
                    <p>
                        ...
                        >
                        around any
                        <abbr title="HyperText Markup Language">HTML</abbr> as
                        the quote.
                    </p>
                    <hr />
                </div>
            ...
            <b-col md="6">
                <b-card no-body>
                    ...
                    <b-card-body>
                        <b-card-text>
                            Left aligned basic blockquotes. Use text utilities
                            classes like
                            <code>.text-center / .text-right</code> as needed to
