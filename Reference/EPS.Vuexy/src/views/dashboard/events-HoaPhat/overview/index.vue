...
export default {
    ...
    methods: {
        async getStatsData() {
            this.$services
                .get(`/dashboard/dashboard-events/vehicle-statics/hoaphat`)
                .then((data) => {
                    this.loadVehicleChartData(data.data.data)
                    ...
                    this.statsData[0].dataStats[0].value = inData
                    this.statsData[0].dataStats[1].value = outData
                })
            ...
            this.$services
                .get(`/dashboard/dashboard-events/conveyor-events/hoaphat`)
                .then((data) => {
