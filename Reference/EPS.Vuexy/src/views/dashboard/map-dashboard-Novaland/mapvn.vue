        ...
        <b-container fluid class="p-0 h-100">
            <b-row class="no-gutters h-100">
                ...
                <b-col v-if="showSidebar" xl="2" class="pl-1 h-100">
                    <div v-if="showStatsPanel" class="custom-stats-panel h-100">
                            ...
                            <div class="statistics-container">
                                ...
                                <div class="stat-group-compact">
                                    <div class="stat-group-header-compact">
                                        ...
                                        <span>{{
                                            $t(
                                                'Events.MapDashboard.AccessControl'
                                            )
                                        }}</span>
                                    </div>
                                ...
                                <div class="stat-group-compact">
                                    <div class="stat-group-header-compact">
                                        ...
                                        />
                                        <span>{{
                                            $t('Events.MapDashboard.Railing')
                                        }}</span>
                                    </div>
                                    <div class="stat-row-compact">
                                        <div
                                            class="stat-item-compact flex-fill w-33"
                                        >
                                            <div
                                                class="stat-indicator-compact bg-danger"
                                            ></div>
                                        ...
                                        >
                                            ...
                                            <div class="stat-content-compact">
                                                ...
                                                <div class="stat-label-compact">
                                                    {{
                                                        $t(
                                                            'Events.MapDashboard.NoSafetyRope'
                                                        )
                                                    }}
                                                </div>
                                            </div>
                                        ...
                                        >
                                            ...
                                            <div class="stat-content-compact">
                                                ...
                                                <div class="stat-label-compact">
                                                    {{
                                                        $t(
                                                            'Events.MapDashboard.WorkingNearOpenEdge'
                                                        )
                                                    }}
                                                </div>
                                            </div>
                                ...
                                <div class="stat-group-compact">
                                    <div class="stat-group-header-compact">
                                        ...
                                        <span>{{
                                            $t(
                                                'Events.MapDashboard.VehicleMonitoring'
                                            )
                                        }}</span>
                                    </div>
                                    <div class="stat-row-compact">
                                        ...
                                        >
                                            ...
                                            <div class="stat-content-compact">
                                                ...
                                                <div class="stat-label-compact">
                                                    {{
                                                        $t(
                                                            'Events.MapDashboard.NotCovered'
                                                        )
                                                    }}
                                                </div>
                                            </div>
    ...
    methods: {
        ...
        getShowTable() {
            ...
            if (eventTypeSelected) {
                Object.keys(this.showTable).forEach((key) => {
        ...
        loadAllEventByArea(areaId) {
            ...
            //new 
            this.loadFenceStatistic(0, areaId)
            this.loadPeopleStatistic(0, areaId)
            this.loadEquipmentStatistic(0, areaId)
            this.loadContStatistic(0, areaId)
        },
        ...
        // giám sát xe hàng
        async loadContStatistic(deviceId, areaId) {
            const response = await this.$services.get(
                `/dashboard/cont/count-statistic?deviceId=${deviceId}&areaId=${areaId}`
            )
            const { data } = response.data
            console.log('Cont Statistic Data:', data)
            if (deviceId === 0) {
                this.statisticAll.coverCont = data.covered
                this.statisticAll.uncoverCont = data.uncovered
            }
            // Load theo thiết bị
            else if (areaId === 0) {
                this.statistic = data
        ...
        // giám sát đồ bảo hộ
        async loadEquipmentStatistic(deviceId, areaId) {
            const response = await this.$services.get(
                `/dashboard/equipment/count-statistic?deviceId=${deviceId}&areaId=${areaId}`
            )
            const { data } = response.data
            console.log('Equipment Statistic Data:', data)
            if (deviceId === 0) {
                this.statisticAll.full = data.full
                this.statisticAll.notFull = data.notFull
            }
            // Load theo thiết bị
            else if (areaId === 0) {
                this.statistic = data
        ...
        // giám ra vào
        async loadPeopleStatistic(deviceId, areaId) {
            const response = await this.$services.get(
                `/dashboard/people-counting/count-statistic?deviceId=${deviceId}&areaId=${areaId}`
            )
            const { data } = response.data
            console.log('People Statistic Data:', data)
            if (deviceId === 0) {
                this.statisticAll.peopleIn = data.in
                this.statisticAll.peopleOut = data.out
            }
            // Load theo thiết bị
            else if (areaId === 0) {
                this.statistic = data
        ...
        // giám sát hàng rào
        async loadFenceStatistic(deviceId, areaId) {
            const response = await this.$services.get(
                `/dashboard/fence/count-statistic?deviceId=${deviceId}&areaId=${areaId}`
            )
            const { data } = response.data
            console.log('Fence Statistic Data:', data)
            if (deviceId === 0) {
                this.statisticAll.missingFence = data.missingFence
                this.statisticAll.nearEdge = data.nearEdge
                this.statisticAll.noSafetyHarness = data.noSafetyHarness
            }
            // Load theo thiết bị
            else if (areaId === 0) {
                this.statistic = data
