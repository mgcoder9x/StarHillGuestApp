<template>
    <div class="bg-light">
        <MapVn
            ...
            :is-show-img-map="mapConfig.isShowImgMap"
            :url-img-overlay="mapConfig.urlImgOverlay"
            style="width: 100%"
        ></MapVn>
    </div>
</template>
...
import MapVn from './mapvn-bdbp.vue'
    ...
    data() {
        return {
            mapConfig: {
                ...
                isShowImgMap: false, // false = tự động load từ company, true = dùng urlImgOverlay
                urlImgOverlay: null, // null = tự động load từ company, có giá trị = dùng ảnh custom
            },
            eventType: [],
            items: [],
            searchForm: {},
