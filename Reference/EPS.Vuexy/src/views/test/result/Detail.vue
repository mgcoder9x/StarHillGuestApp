                    ...
                    <b-row cols="1" align-h="center">
                        ...
                        <b-col md="8" v-if="!test.isMock">
                            <b-form-group label="Ngày bắt đầu hiệu lực" label-cols-md="4" label-class="required">
                                <validation-provider #default="{ errors }"
                                    :rules="`required|validateCourseDates:${test.startTime}`" :name="
                                        this.$t(
                        ...
                        <b-col md="8" v-if="!test.isMock">
                            <b-form-group label="Ngày hết hiệu lực" label-class="required" label-cols-md="4">
                                <validation-provider #default="{ errors }"
                                    :rules="`required|validateEndDate:${test.startDate}`" :name="
                                        this.$t(
                    ...
                    <b-row>
                        <b-col>
                            <div class="text-center">
                                ...
                                <b-button v-if="!editing && authorize(['ManageSTDTest'])" 
    ...
    methods: {
        ...
        async validationForm() {
            ...
            this.$refs.rules.validate().then((success) => {
                if (success) {
                    this.$services
                        .put(`/stdTest/${this.classId}`, this.test)
                        .then((response) => {
                            this.$toast({
                                component: ToastificationContent,
                                position: 'top-right',
                            ...
                            this.cancel()
                            this.$router.push({ name: 'study-test-list' })
                        })
                        .catch((error) => {
                            this.$toast({
                                component: ToastificationContent,
