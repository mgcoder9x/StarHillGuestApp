        ...
        <div class="media-list media-bordered">
            <b-media>
                <template #aside>
                    <b-img
                        :src="
                            require('@/assets/images/portrait/small/avatar-s-23.jpg')
                        "
                        blank-color="#ccc"
                        width="64"
                        alt="placeholder"
            ...
            <b-media>
                ...
                <b-card-text>
                    Tootsie roll dessert tart candy canes ice cream gingerbread
                    cookie. Jelly jelly-o bear claw bear claw halvah. Biscuit
                    icing pastry tootsie roll gingerbread croissant chupa chups.
                </b-card-text>
            </b-media>
            ...
            <b-media>
                <template #aside>
                    <b-img
                        :src="
                            require('@/assets/images/portrait/small/avatar-s-15.jpg')
                        "
                        blank-color="#ccc"
                        width="64"
                        alt="placeholder"
