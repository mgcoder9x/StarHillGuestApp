        ...
        <div class="media-list media-bordered">
            ...
            <b-media right-align class="text-right">
                <template #aside>
                    <b-img
                        :src="
                            require('@/assets/images/portrait/small/avatar-s-14.jpg')
                        "
                        blank-color="#ccc"
                        width="64"
                        alt="placeholder"
            ...
            <b-media right-align class="text-right">
                <template #aside>
                    <b-img
                        :src="
                            require('@/assets/images/portrait/small/avatar-s-21.jpg')
                        "
                        blank-color="#ccc"
                        width="64"
                        alt="placeholder"
                ...
                <b-card-text>
                    ...
                    jelly-o bear claw ice cream sugar plum biscuit. Lemon drops
