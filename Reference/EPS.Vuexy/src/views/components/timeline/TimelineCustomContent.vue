    ...
    <b-card-code title="Custom Content">
        <app-timeline>
            ...
            <app-timeline-item variant="secondary">
                ...
                <b-media>
                    <template #aside>
                        <b-avatar
                            :src="
                                require('@/assets/images/avatars/12-small.png')
                            "
                        />
                    </template>
                ...
                >
                    <b-media>
                        <template #aside>
                            <b-avatar
                                :src="
                                    require('@/assets/images/avatars/1-small.png')
                                "
                            />
                        </template>
                        <h6>Katy Turner</h6>
            ...
            <app-timeline-item variant="danger">
                ...
                <p>
                    Develop an online store of electronic devices for the
                    provided layout, as well as develop a mobile version of it.
                    The must be compatible with any CMS.
                </p>
                <div
                    class="d-flex flex-sm-row flex-column justify-content-between align-items-start"
                >
