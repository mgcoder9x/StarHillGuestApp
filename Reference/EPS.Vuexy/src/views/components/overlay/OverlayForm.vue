<template>
    <b-card-code title="Form confirmation prompt and upload status">
        <b-card-text>
            <span
                >This example is a bit more complex, but shows the use of
            </span>
            <code>no-wrap</code>
            <span> , and using the </span>
            <code>overlay</code>
            <span>
                slot to present the user with a prompt dialog, and once
                confirmed it shows a uploading status indicator. This example
                also demonstrates additional accessibility markup.
            </span>
        </b-card-text>
