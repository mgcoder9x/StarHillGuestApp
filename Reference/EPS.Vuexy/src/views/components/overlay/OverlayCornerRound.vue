<template>
    <b-card-code title="Overlay corner rounding">
        <b-card-text>
            <span>
                By default, the overlay backdrop has square corners. If the
                content you are wrapping has rounded corners, you can use the
            </span>
            <code>rounded</code>
            <span>
                prop to apply rounding to the overlay's corners to match the
                obscured content's rounded corners.</span
            >
        </b-card-text>
                ...
                <b-col md="6">
                    ...
                    >
                        <b-img
                            ...
                            height="300"
                            :src="
                                require('@/assets/images/banner/banner-27.jpg')
                            "
                            alt="Image 1"
                        />
                    </b-overlay>
