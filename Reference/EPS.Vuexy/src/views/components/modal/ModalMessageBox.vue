<template>
    <b-card-code title="Confirm message box">
        <b-card-text class="mb-0">
            <span
                >BootstrapVue provides a few built in Message Box methods on the
                exposed
            </span>
            <code>this.$bvModal</code>
            <span>
                object. These methods provide a way to generate simple OK and
                Confirm style modal messages, from anywhere in your app without
                having to explicitly place a
            </span>
            <code>&lt;b-modal&gt;</code>
        ...
        <b-card-text class="mt-2">
            ...
            <span class="font-weight-bold">{{ String(boxOne) }}</span>
        </b-card-text>
        <b-card-text class="mb-0">
            Second modal return value:
            <span class="font-weight-bold">{{ String(boxTwo) }}</span>
        </b-card-text>
