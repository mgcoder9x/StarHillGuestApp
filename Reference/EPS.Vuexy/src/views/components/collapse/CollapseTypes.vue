<template>
    <b-card-code title="Types">
        <b-card-text class="mb-0">
            ...
            dolores nostrum modi, dolor, neque distinctio vel ut itaque numquam
            quos magni dolore ea earum tempore est excepturi perspiciatis,
            placeat odio.
        </b-card-text>
        <!-- radio button -->
        <b-form-group>
        ...
        <app-collapse accordion :type="collapseType">
            <app-collapse-item title="Accordion Item 1">
                ...
                lollipop toffee. Macaroon donut liquorice powder candy carrot
                cake macaroon fruitcake. Cookie toffee lollipop cotton candy ice
                cream dragée soufflé. Cake tiramisu lollipop wafer pie soufflé
                dessert tart. Biscuit ice cream pie apple pie topping oat cake
                dessert. Soufflé icing caramels. Chocolate cake icing ice cream
