<template>
    <b-card-code title="Popover Variant">
        <b-card-text class="mb-0">
            <span
                >BootstrapVue's popovers support contextual color variants via
                our custom CSS, via the</span
            >
            <code>variant</code>
            <span> prop:</span>
        </b-card-text>
        ...
        <div class="demo-inline-spacing">
            <!-- default -->
            <b-button id="popover-button-default" variant="gradient-primary">
                Default
            </b-button>
            ...
            >
                ...
                <span
                    ...
                    cake lemon drops. Muffin sugar plum marzipan pie.</span
                >
            </b-popover>
