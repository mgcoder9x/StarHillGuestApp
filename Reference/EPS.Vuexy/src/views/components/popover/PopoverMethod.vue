<template>
    <b-card-code title="Popover Methods">
        <b-card-text class="mb-0">
            This is considered a “manual” popovering of the popover. popovers
            with zero-length titles are never displayed.
        </b-card-text>
        ...
        <div class="demo-inline-spacing">
            ...
            >
                ...
                <span
                    >Fruitcake candy cheesecake jelly beans cake gummies. Cotton
                    candy I love sweet roll jujubes pastry cake halvah
                    cake.</span
                >
            </b-popover>
