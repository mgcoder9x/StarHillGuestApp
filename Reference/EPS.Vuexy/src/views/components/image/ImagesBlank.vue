<template>
    <b-card-code title="Blank (or solid color) images">
        <b-card-text class="mb-0">
            <code>&lt;b-img&gt;</code>
            <span>
                provides built-in support for generating blank images
                (transparent by default) of any width and height, by setting the
            </span>
            <code>blank</code>
            ...
            <code>&lt;b-img&gt;</code>
            <span>
                props to change the style/behavior of the generated image.</span
            >
        </b-card-text>
