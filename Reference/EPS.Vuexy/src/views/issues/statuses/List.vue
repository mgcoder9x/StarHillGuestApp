                    ...
                    <b-row>
                        <b-col sm="8" md="7" lg="6">
                            <b-form-group
                                :label="
                                    this.$t(
                                        'Statuses.List.SearchForm.StatusId'
                                    )
                                "
        ...
        <b-card title="">
            ...
            >
                <template slot="table-row" slot-scope="props">
                    ...
                    <!-- Column: Type (dịch i18nKey lấy từ DB) -->
                    ...
                    <span v-else-if="props.column.field === 'action'">
                        <div class="text-nowrap">
                            <b-button
                                ...
                                :to="{
                                    path: `/issue/statuses/detail/${props.row.id}`,
                                }"
                            >
...
export default {
    ...
    data() {
        return {
            ...
            columns: [
                {
                    label: 'Statuses.List.Table.statusId',
                    field: 'id',
                },
                {
                    label: 'Statuses.List.Table.Name',
                    field: 'name',
                },
                {
                    label: 'Statuses.List.Table.Type',
                    field: 'type',
                },
                {
                    label: 'Statuses.List.Table.Color',
                    field: 'color',
                },
                {
                    label: 'Statuses.List.Table.Operation',
                    field: 'action',
                },
            ],
        }
                        ...
                        .catch(error => {
                            this.$toast({
                                ...
                                props: {
                                    ...
                                    variant: 'danger',
                                    text: this.$t(
                                        `Statuses.error.${error.errorCode}`
                                    ),
                                },
                            })
                        })
