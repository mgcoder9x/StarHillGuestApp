                        ...
                        <b-card align="center">
                            ...
                            <div class="annual-plan">
                                ...
                                <small
                                    ...
                                    >USD
                                    {{
                                        pricing.basicPlan.yearlyPlan.totalAnual
                                    }}
                                    / year</small
                                >
                            </div>
                            ...
                            <b-list-group class="list-group-circle text-left">
                                <b-list-group-item
                                    v-for="(data, index) in pricing.basicPlan
                                        .planBenefits"
                                    :key="index"
                                >
                                    {{ data }}
                        ...
                        <b-card class="popular" align="center">
                            ...
                            <div class="annual-plan">
                                ...
                                <small
                                    ...
                                    >USD
                                    {{
                                        pricing.standardPlan.yearlyPlan
                                            .totalAnual
                                    }}
                                    / year</small
                                >
                            ...
                            <b-list-group class="list-group-circle text-left">
                                <b-list-group-item
                                    v-for="(data, index) in pricing.standardPlan
                                        .planBenefits"
                                    :key="index"
                                >
                                    {{ data }}
                        ...
                        <b-card align="center">
                            ...
                            <div class="annual-plan">
                                ...
                                <small
                                    ...
                                    >USD
                                    {{
                                        pricing.enterprisePlan.yearlyPlan
                                            .totalAnual
                                    }}
                                    / year</small
                                >
                            ...
                            <!-- plan benefit -->
                            <b-list-group
                                v-for="(data, index) in pricing.enterprisePlan
                                    .planBenefits"
                                :key="index"
