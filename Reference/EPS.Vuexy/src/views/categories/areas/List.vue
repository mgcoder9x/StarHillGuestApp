    ...
    <div>
                    ...
                    <b-row>
                        <b-col sm="8" md="7" lg="6">
                            <b-form-group
                                :label="
                                    this.$t(
                                        'categories.areas.list.searchForm.label.areaCodeName'
                                    )
                                "
                            ...
                            >
                                <b-form-input
                                    ...
                                    :placeholder="
                                        this.$t(
                                            'categories.areas.list.searchForm.placeholder.areaCodeName'
                                        )
                                    "
                                />
                            </b-form-group>
        ...
        <b-card title="">
            <b-button
                ...
                variant="primary"
                :to="{ path: '/categories/areas/create' }"
                ...
                >
                    ...
                    <template slot="action" slot-scope="props">
                        <b-button
                            ...
                            :to="{
                                path: `/categories/areas/detail/${props.row.id}`,
                            }"
                        >
            ...
            table: {
                ...
                columns: [
                    ...
                    },
                    {
                        property: 'code',
                        title: this.$t(
                            'categories.areas.list.table.label.areaCode'
                        ),
                        direction: null,
                        filterable: true,
                    },
                    {
                        property: 'name',
                        title: this.$t(
                            'categories.areas.list.table.label.areaName'
                        ),
                        direction: null,
                        filterable: true,
                        groupable: false,
                    ...
                    },
                    {
                        property: 'treeIndex',
                        title: this.$t(
                            'categories.areas.list.table.label.treeIndex'
                        ),
                        direction: null,
                        filterable: false,
                        groupable: false,
                    },
                    {
                        property: 'note',
                        title: this.$t(
                            'categories.areas.list.table.label.note'
                        ),
                        direction: null,
                        filterable: true,
                        groupable: false,
                    ...
                    },
                    {
                        property: 'action',
                        title: this.$t(
                            'categories.areas.list.table.label.action'
                        ),
                        direction: null,
                        filterable: false,
                        groupable: false,
    ...
    methods: {
        async getTreeAreas() {
            try {
                ...
                this.table.rows = TreeHelper.sortChildren(res.data.data)
            } catch (error) {
        ...
        async deleteArea(id) {
            ...
            if (isConfirmed) {
                try {
                    const res = await this.$services.delete(`/areas/${id}`)
        ...
        refreshTableHeader() {
            ...
            this.table.columns[4].title = this.$t(
                'categories.areas.list.table.label.action'
            )
        },
    },
