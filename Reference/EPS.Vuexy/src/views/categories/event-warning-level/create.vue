<template>
    <div>
        <b-card :title="$t('EventWarningLevel.Detail.TitleCreate')">
            <validation-observer
                ref="formRules"
                ...
                <b-form @submit.prevent="handleSubmit(onSubmit)">
                            ...
                            >
                                ...
                                >
                                    <b-form-input
                                        ...
                                        :placeholder="
                                            $t(
                                                'EventWarningLevel.Detail.Form.IdPlaceholder'
                                            )
                                        "
                                    />
                    ...
                    <div class="d-flex justify-content-center mt-2 gap-1">
                        ...
                        <b-button
                            ...
                            class="mr-1"
                            @click="
                                $router.push({ name: 'event-warning-level' })
                            "
                        >
                            {{ $t('Button.Cancel') }}
                        </b-button>
...
export default {
    ...
    methods: {
        ...
        async onSubmit() {
            this.isSaving = true
            try {
                const {data }=await this.$services.post('/event-warning-levels', this.form)
                this.$toast({
                ...
                this.$router.push({ name: 'event-warning-level' })
            } catch (err) {
                this.$toast({
                    component: ToastificationContent,
                    position: 'top-right',
