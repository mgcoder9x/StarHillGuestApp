                    ...
                    <b-row>
                        <b-col sm="8" md="7" lg="6">
                            <b-form-group
                                :label="
                                    this.$t(
                                        'categories.departments.list.searchForm.label.departmentCodeName'
                                    )
                                "
                            ...
                            >
                                <b-form-input
                                    ...
                                    :placeholder="
                                        this.$t(
                                            'categories.departments.list.searchForm.placeholder.departmentCodeName'
                                        )
                                    "
                                    type="text"
                                />
                ...
                >
                    <template slot="top">
                        <b-button
                            ...
                            variant="primary"
                            :to="{ path: '/categories/departments/create' }"
                            class="mb-1"
                        >
                    ...
                    <template slot="action" slot-scope="props">
                        <b-button
                            ...
                            :to="{
                                path: `/categories/departments/detail/${props.row.id}`,
                            }"
                        >
                        ...
                        <b-button
                            ...
                            :to="{
                                path: `/categories/departments/create`,
            ...
            table: {
                ...
                columns: [
                    ...
                    },
                    {
                        property: 'code',
                        title: this.$t(
                            'categories.departments.list.table.label.departmentCode'
                        ),
                        direction: null,
                        filterable: true,
                    },
                    {
                        property: 'name',
                        title: this.$t(
                            'categories.departments.list.table.label.departmentName'
                        ),
                        direction: null,
                        filterable: true,
                        groupable: false,
...

                    {
                        property: 'action',
                        title: this.$t(
                            'categories.departments.list.table.label.action'
                        ),
                        direction: null,
                        filterable: false,
                        groupable: false,
    ...
    methods: {
        async getTreeDepartments() {
            try {
                ...
                this.table.rows = Array.isArray(res.data.data)
                    ? res.data.data
                    : []
            } catch {
                console.log('error')
