    ...
    data() {
        return {
            searchDatas: [
                {
                    ...
                    label: 'categories.groups.list.searchForm.label.compName',
                    placeholder:
                        'categories.groups.list.searchForm.label.compName',
                    options: [],
                ...
                },
                {
                    ...
                    label: 'categories.groups.list.searchForm.label.groupCodeName',
                    placeholder:
                        'categories.groups.list.searchForm.label.groupCodeName',
                },
            ],
            searchForm: {
                filterCompId: null,
            ...
            table: {
                ...
                columns: [
                    {
                        label: 'categories.groups.list.table.label.companyName',
                        field: 'compName',
                        visible: false,
                    },
                    {
                        label: 'categories.groups.list.table.label.groupCode',
                        field: 'groupCode',
                    },
                    {
                        label: 'categories.groups.list.table.label.groupName',
                        field: 'groupName',
                    },
                    {
                        label: 'categories.groups.list.table.label.action',
                        field: 'action',
                    },
                ],
            },
            ...
            routerLink: {
                create: '/categories/groups/create/',
                detail: '/categories/groups/detail/',
                delete: '/groups/',
            },
        }
    },
