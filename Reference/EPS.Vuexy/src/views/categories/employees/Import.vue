                    ...
                    <b-row>
                        ...
                        <b-col md="2">
                            ...
                            <a
                                ...
                                class="btn btn-success"
                                style="float: right; color: white"
                                href="/download/template_NhanVien.xlsx"
                                >{{
                                    $t(
                                        'categories.employees.import.importSample'
                                    )
...
export default {
    ...
    methods: {
        clickTem() {
            ...
            link.href = `/download/employee_import_template.xlsx`
            link.click()
        ...
        downloadReport() {
            if (this.importResults.downloadUrl) {
                ...
                // let urldownload = baseURL + '/' + this.importResults.downloadUrl.replace(/\\/g, '/')
                const urldownload = `${baseURL}/api/employees/import-result?path=${this.importResults.downloadUrl.replace(/\\/g, '/')}`
