<template>
    <div>
                    ...
                    <b-row>
                        <b-col md="6">
                            <b-form-group
                                :label="
                                    this.$t(
                                        'categories.productionLines.list.searchForm.label.filterText'
                                    )
                                "
                        ...
                        <b-col md="6">
                            <b-form-group
                                :label="
                                    this.$t(
                                        'categories.productionLines.list.searchForm.label.status'
                                    )
                                "
                            ...
                            >
                                <v-select
                                    ...
                                    :placeholder="
                                        this.$t(
                                            'categories.productionLines.list.searchForm.placeholder.status'
                                        )
                                    "
        ...
        <b-card title="">
            <div>
                <b-button
                    v-if="authorize(['ManageProductionLine'])"
                    variant="primary"
                    :to="{ path: '/categories/productionLines/create' }"
            ...
            <!-- table -->
            <BasicTable
                ref="productionLineTable"
                :columns="columns"
                data-url="/production-lines"
                :search-form="searchForm"
                storage-name="productionLineTable"
            >
                <template slot="table-row" slot-scope="props">
                    ...
                    <span v-else-if="props.column.field === 'action'">
                        <div class="text-nowrap">
                            <b-button
                                v-if="authorize(['ViewProductionLine'])"
                                v-b-tooltip.hover
                                v-waves
                                ...
                                :to="{
                                    path: `/categories/productionLines/detail/${props.row.id}`,
                                }"
                            >
...
export default {
    ...
    data() {
        return {
            ...
            columns: [
                {
                    label: 'categories.productionLines.list.table.label.name',
                    field: 'name',
                },
                {
                    label: 'categories.productionLines.list.table.label.code',
                    field: 'code',
                },
                {
                    label: 'categories.productionLines.list.table.label.status',
                    field: 'status',
                },
                {
