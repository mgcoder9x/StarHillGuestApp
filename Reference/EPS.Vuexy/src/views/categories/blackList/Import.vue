    ...
    <validation-observer ref="rules">
        <b-card no-body>
            <b-card-body>
                <div slot="header">
                    <strong>{{
                        $t('categories.blacklist.import.header')
                    }}</strong>
                </div>
                <b-form @submit="onSubmit">
                    <b-row>
                        <b-col md="10">
                            <b-form-group
                                :label="
                                    $t('categories.blacklist.import.import')
                                "
                                :label-cols="2"
                                :horizontal="true"
                                label-align-md="left"
                            ...
                            >
                                <validation-provider
                                    ...
                                    :name="
                                        $t(
                                            'categories.blacklist.import.importRequire'
                                        )
                                    "
                                >
                                    <b-form-file
                                        ...
                                        :placeholder="
                                            $t(
                                                'categories.blacklist.import.importPlaceholder'
                                            )
                                        "
                        ...
                        <b-col md="2">
                            <a
                                ...
                                >{{
                                    $t(
                                        'categories.blacklist.import.importSample'
                                    )
                                }}</a
                            >
                            <!-- <a
                                ...
                                class="btn btn-success"
                                style="float: right; color: white"
                                href="/download/template_Blacklist.xlsx"
                                >{{
                                    $t(
                                        'categories.blacklist.import.importSample'
                                    )
        ...
        <b-modal
            ...
            :title="$t('categories.blacklist.import.resultsTitle')"
            hide-footer
        ...
        >
            <div class="text-center p-3">
                ...
                <!-- Title -->
                <h5 class="mb-3">
                    {{ $t('categories.blacklist.import.IMPORT_SUCCESS') }}
                </h5>
                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between mb-2">
                        <strong
                            >{{
                                $t(
                                    'categories.blacklist.import.IMPORT_TOTAL_COUNT'
                                )
                            }}:</strong
                        >
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        <strong
                            >{{
                                $t(
                                    'categories.blacklist.import.IMPORT_SUCCESS_COUNT'
                                )
                            }}:</strong
                        >
                    ...
                    >
                        <strong
                            >{{
                                $t(
                                    'categories.blacklist.import.IMPORT_ERROR_COUNT'
                                )
                            }}:</strong
                        >
                ...
                <div>
                    <b-row md="12" class="d-flex justify-content-center gap-2">
                        <b-col md="6">
                            ...
                            >
                                {{ $t('categories.blacklist.import.Download') }}
                            </b-button>
                        </b-col>
                        <b-col md="6">
                            <b-button
                            ...
                            >
                                {{ $t('categories.blacklist.import.Close') }}
                            </b-button>
                        </b-col>
                    </b-row>
                </div>
...
export default {
    ...
    methods: {
        clickTem() {
            ...
            link.href = `/download/blacklist_import_template.xlsx`
            link.click()
        ...
        onChange(evt) {
            ...
            if (
                ...
                // alert(this.t('categories.blacklist.import.fileInputXlxs'))
                return
            }
            if (f.size > 5000000) {
                this.$refs['file-input'].reset()
                // alert(this.t('categories.blacklist.import.fileInput50Mb'))
                return
            }
        ...
        downloadReport() {
            if (this.importResults.downloadUrl) {
                ...
                // const urldownload = `${
                //     baseURL
                // }/${this.importResults.downloadUrl.replace(/\\/g, '/')}`
        ...
        showErrorToast(error) {
            this.$toast({
                ...
                props: {
                    ...
                    variant: 'danger',
                    text: this.$t(
                        `categories.blacklist.error.${error.response.data.errorCode}`
                    ),
                },
            })
        },
