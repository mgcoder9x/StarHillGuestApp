<template>
    <div>
        ...
        <b-card title="">
            ...
            <b-modal
                v-model="isModalOpen"
                :title="$t('common.form.label.employeeImage')"
...
export default {
    ...
    data() {
        return {
            ...
            // --- ROUTER ---
            routerLink: {
                create: '/categories/blackLists/create/',
                detail: '/categories/blackLists/detail/',
                import: '/categories/blackLists/import/',
                delete: '/employees/',
            },
    ...
    computed: {
        ...
        tableColumns() {
            return [
                ...
                {
                    label: 'categories.employees.list.table.label.code',
                    field: 'code',
                },
                {
                    label: 'Họ Tên',
                ...
                {
                    label: 'categories.employees.common.form.label.birthday',
                    field: 'birthday',
                    type: 'date',
                ...
                {
                    label: 'categories.employees.common.form.label.address',
                    field: 'address',
                },
                {
                    label: 'categories.employees.list.table.label.status',
                    field: 'status',
                    formatFn: (v) =>
                        v === 1
    ...
    created() {
        ...
        this.searchForm.filterCompId = accessToken?.companyId || null
        ...
        if (compIdx !== -1)
            this.searchDatas[compIdx].modelValue = this.searchForm.filterCompId
