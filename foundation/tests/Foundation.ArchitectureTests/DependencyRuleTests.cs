...
namespace Foundation.ArchitectureTests;
...
{
    private static readonly System.Reflection.Assembly SharedKernel = typeof(Foundation.SharedKernel.AssemblyMarker).Assembly;
    private static readonly System.Reflection.Assembly Domain = typeof(Foundation.Domain.AssemblyMarker).Assembly;
    private static readonly System.Reflection.Assembly Application = typeof(Foundation.Application.AssemblyMarker).Assembly;

    private const string DomainNs = "Foundation.Domain";
    private const string ApplicationNs = "Foundation.Application";
    private const string InfrastructureNs = "Foundation.Infrastructure";
    private const string ApiNs = "Foundation.Api";
