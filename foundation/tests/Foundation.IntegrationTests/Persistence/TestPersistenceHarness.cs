...
using Foundation.Infrastructure.Persistence;
...
/// <summary>DbContext test dẫn xuất <see cref="FoundationDbContext"/> — thêm DbSet nghiệp vụ giả lập.</summary>
public sealed class SampleDbContext : FoundationDbContext
{
