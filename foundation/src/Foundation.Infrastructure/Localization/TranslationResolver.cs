using Foundation.Application.Localization;
using Foundation.SharedKernel.Entities;

namespace Foundation.Infrastructure.Localization;

/// <summary>
/// Hiện thực <see cref="ITranslationResolver"/> — thuật toán fallback theo thiết kế 18 §2-5.
/// So khớp mã ngôn ngữ không phân biệt hoa/thường, không dùng ToLower (tránh CA1308) — so trực tiếp OrdinalIgnoreCase.
/// </summary>
