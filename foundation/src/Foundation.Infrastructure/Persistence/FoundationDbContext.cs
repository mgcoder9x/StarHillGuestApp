...
public abstract class FoundationDbContext : DbContext
{
    ...
    protected FoundationDbContext(DbContextOptions options, IDateTimeProvider clock, ICurrentUser currentUser)
        : base(options)
    {
        _clock = clock;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(FoundationDbContext).Assembly);
