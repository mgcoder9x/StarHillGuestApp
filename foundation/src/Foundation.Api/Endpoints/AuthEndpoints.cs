...
public static class AuthEndpoints
{
    ...
    public static IEndpointRouteBuilder MapFoundationAuthEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ArgumentNullException.ThrowIfNull(endpoints);

        var group = endpoints.MapGroup(BasePath).RequireRateLimiting(RateLimiting.FoundationRateLimitExtensions.AuthPolicy);
