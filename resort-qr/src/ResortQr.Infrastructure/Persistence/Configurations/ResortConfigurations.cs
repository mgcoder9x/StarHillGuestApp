...
/// <summary>EF config Resort — ràng buộc kỹ thuật (KHÔNG ở Domain).</summary>
...
/// <summary>EF config ResortSettings — 1-1 với Resort (unique FK, D5) + CHECK ngưỡng vận hành.</summary>
...
/// <summary>EF config ResortLanguage — unique (resort,code); partial unique IsDefault ở AppDbContext (bool provider-aware).</summary>
