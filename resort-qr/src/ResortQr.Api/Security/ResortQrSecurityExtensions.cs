...
/// </summary>
public static class ResortQrSecurityExtensions
{
    private static readonly string[] AllowedMethods = ["GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS"];

    public static IServiceCollection AddResortQrSecurity(this IServiceCollection services, IConfiguration configuration)
    {
