...
namespace ResortQr.Api.RateLimiting;
...
/// </summary>
public static class ResortQrRateLimitExtensions
{
    public const string AuthPolicy = "auth";

    public static IServiceCollection AddResortQrRateLimiting(this IServiceCollection services, IConfiguration configuration)
    {
