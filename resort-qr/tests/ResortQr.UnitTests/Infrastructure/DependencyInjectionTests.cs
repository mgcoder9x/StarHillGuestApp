...
using ResortQr.Infrastructure.Time;
...
public sealed class DependencyInjectionTests
{
    ...
    private static ServiceProvider BuildResortQrProvider()
    {
    ...
    {
        using var provider = BuildResortQrProvider();
    ...
    public void Conflicting_lifetime_markers_should_throw()
    {
        ...
        var ex = Assert.Throws<InvalidOperationException>(
            () => services.AddResortQrServices(typeof(ConflictingService).Assembly));
