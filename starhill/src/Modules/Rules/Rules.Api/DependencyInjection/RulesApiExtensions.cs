...
/// D-Rules.4c: admin (RulesAdminEndpointModule) + guest (RulesGuestEndpointModule — read/acknowledge nội quy).
/// </summary>
public static class RulesApiExtensions
{
    public static IServiceCollection AddRulesApi(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IEndpointModule, RulesGuestEndpointModule>();
        return services;
    }
}
