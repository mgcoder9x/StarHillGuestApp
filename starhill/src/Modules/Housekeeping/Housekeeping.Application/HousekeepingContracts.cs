...
public sealed record RequestHousekeepingInput(Guid ResortId, Guid RoomId, Guid GuestSessionId, Guid GuestVisitId);
...
/// <summary>View ticket guest-facing (không lộ actor/method nội bộ ngoài trạng thái + mốc thời gian).</summary>
